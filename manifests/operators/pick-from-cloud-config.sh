...
# The base manifests/tree.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/tree.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
